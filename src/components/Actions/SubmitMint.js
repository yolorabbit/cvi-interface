...
const SubmitMint = () => {
    ...
    }, [account, activeToken.decimals, activeToken.name, activeToken.rel.volTokenKey, delayFee.delayTime, dispatch, isActiveInDOM, setAmount, setIsOpen, tokenAmount, updateAvailableBalance, w3])
